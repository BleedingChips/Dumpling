...
#include "../Win32/aid.h"
namespace Dumpling::Dx11
{

	template<typename T> using ComPtr = Dumpling::Win32::ComPtr<T>;
	template<typename T> using intrusive_ptr = Potato::Tool::intrusive_ptr<T>;
	...
	private:
		...
		intrusive_ptr<Command> m_waitiing;
		intrusive_ptr<Command> m_buffer;
	...
	private:
		...
		std::deque<intrusive_ptr<CommandInterface>> m_list;
