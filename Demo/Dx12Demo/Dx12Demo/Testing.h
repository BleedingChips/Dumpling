#pragma once
//*********************************************************************
// BoxApp.cpp by Frank Luna (C) 2015 All RightsReserved.
//
// Shows how to draw a box in Direct3D 12.
//
// Controls:
// Hold the left mouse button down and move the mouse to rotate.
// Hold the right mouse button down and move the mouse to zoom inand
// out.
//*********************************************************************
...
{
	float4x4 WorldViewProj = DirectX::XMMatrixIdentity();
};
...
> ClearDepthStencilView(DepthStencilView(),
	...
	// Indicate a state transition on the resourceusage.
	...
	// Wait until frame commands are complete. Thiswaiting is
		// inefficient and is done for simplicity. Later wewill show how to
	// organize our rendering code so we do not have towait per frame.
		FlushCommandQueue();
}
...
{
	// Shader programs typically require resources asinput(constant
